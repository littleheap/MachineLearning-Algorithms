...
#### ·不平衡数据SVM分类处理效果
<img width="550" height="400" src="./figures/unbalance.png"/>

#### ·手写体数字数据集显示
<img width="550" height="400" src="./figures/hand_writing.png"/>

#### ·手写体预测错误显示
<img width="550" height="400" src="./figures/hand_wrong.png"/>

#### ·不同核函数预测效果对比
<img width="550" height="400" src="./figures/kernal.png"/>

#### ·交叉验证配合SVM实现效果
<img width="550" height="400" src="./figures/CV.png"/>
